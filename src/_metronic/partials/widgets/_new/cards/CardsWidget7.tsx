...
const items: Array<{
  ...
  {name: 'Michael Eberon', src: toAbsoluteUrl('media/avatars/300-3.jpg')},
  {name: 'Susan Redwood', initials: 'S', state: 'primary'},
  {name: 'Melody Macy', src: toAbsoluteUrl('media/avatars/300-3.jpg')},
  {name: 'Perry Matthew', initials: 'P', state: 'danger'},
  {name: 'Barry Walter', src: toAbsoluteUrl('media/avatars/300-3.jpg')},
]
...
const CardsWidget7 = ({className, description, stats, labelColor, textColor}: Props) => (
  <div className={`card card-flush ${className}`}>
    ...
    <div className='card-body d-flex flex-column justify-content-end pe-0'>
      <span className='fs-6 fw-bolder text-gray-800 d-block mb-2'>Heróis de hoje</span>
