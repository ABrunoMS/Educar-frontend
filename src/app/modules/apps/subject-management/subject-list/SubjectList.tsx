...
import { ID, KTSVG } from '@metronic/helpers'
...
const SubjectListWrapper = () => {
  const columns: Column<Subject>[] = [
    ...
    },
    {
      ...
      Cell: ({...props}) => <ActionsCell
        editPath='/apps/subject-management/subject'
  ...
  const {data, isLoading, refetch}: UseQueryResult<PaginatedResponse<Subject>> = useQuery(
    ['subject-list', page, sortBy, sortOrder, filter, search],
